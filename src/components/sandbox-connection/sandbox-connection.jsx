...
const SandboxConnectionForm = () => {
    ...
    const sandbox_mode_options = [{ value: 'Yes', label: 'Yes' }, { value: 'No', label: 'No' }];

    const credentials_type_options = [{ value: 'credentials', label: 'Public & Secret Keys' }, {
        value: 'access_key',
        label: 'Access Token',
    }];

    const card_use_on_checkout_options = [{ value: 'Yes', label: 'Yes' }, { value: 'No', label: 'No' }];

    const card_supported_card_schemes_options = [{ value: 'ausbc', label: `Australian Bank Card` }, {
        value: 'diners', label: 'Diner\'s Club, Diner\'s Club International, Diner\'s Club / Carte Blanche',
    }, { value: 'japcb', label: 'Japanese Credit Bureau' }, { value: 'laser', label: 'Laser' }, {
        value: 'solo',
        label: 'Solo (Paymentech)',
    }, { value: 'mastercard', label: 'MasterCard' }, { value: 'discover', label: 'Discover' }, {
        value: 'amex',
        label: 'American Express',
    }, { value: 'visa', label: 'Visa, Visa Electron' }, { value: 'visa_white', label: 'Visa White' }];

    const card_3ds_options = [{ value: 'Disable', label: 'Disable' }, {
        value: 'Standalone 3DS',
        label: 'Standalone 3DS',
    }, { value: 'In-built 3DS', label: 'In-built 3DS' }];

    const card_fraud_options = [{ value: 'Disable', label: 'Disable' }, {
        value: 'Standalone Fraud',
        label: 'Standalone Fraud',
    }, { value: 'In-built Fraud', label: 'In-built Fraud' }];

    const card_direct_charge_options = [{ value: 'Disable', label: 'Disable' }, { value: 'Enable', label: 'Enable' }];

    const card_card_save_options = [{ value: 'Disable', label: 'Disable' }, { value: 'Enable', label: 'Enable' }];

    const card_card_method_save_options = [{
        value: 'Vault token',
        label: 'Vault token',
    }, { value: 'Customer with Gateway ID', label: 'Customer with Gateway ID' }, {
        value: 'Customer without Gateway ID',
        label: 'Customer without Gateway ID',
    }];

    const bank_accounts_use_on_checkout_options = [{ value: 'Yes', label: 'Yes' }, { value: 'No', label: 'No' }];

    const bank_accounts_bank_account_save_options = [{ value: 'Yes', label: 'Yes' }, { value: 'No', label: 'No' }];
    ...
    const wallets_apple_pay_use_on_checkout_options = [{ value: 'Yes', label: 'Yes' }, { value: 'No', label: 'No' }];

    const wallets_apple_pay_fraud_options = [{ value: 'Disable', label: 'Disable' }, {
        value: 'Enable',
        label: 'Enable',
    }];

    const wallets_apple_pay_direct_charge_options = [{ value: 'Disable', label: 'Disable' }, {
        value: 'Enable',
        label: 'Enable',
    }];

    const wallets_google_pay_use_on_checkout_options = [{ value: 'Yes', label: 'Yes' }, { value: 'No', label: 'No' }];

    const wallets_google_pay_fraud_options = [{ value: 'Disable', label: 'Disable' }, {
        value: 'Enable',
        label: 'Enable',
    }];

    const wallets_google_pay_direct_charge_options = [{ value: 'Disable', label: 'Disable' }, {
        value: 'Enable',
        label: 'Enable',
    }];

    const wallets_paypal_smart_button_use_on_checkout_options = [{ value: 'Yes', label: 'Yes' }, {
        value: 'No',
        label: 'No',
    }];

    const wallets_paypal_smart_button_fraud_options = [{ value: 'Disable', label: 'Disable' }, {
        value: 'Enable',
        label: 'Enable',
    }];

    const wallets_paypal_smart_button_direct_charge_options = [{ value: 'Disable', label: 'Disable' }, {
        value: 'Enable',
        label: 'Enable',
    }];

    const wallets_paypal_smart_button_pay_later_options = [{ value: 'Disable', label: 'Disable' }, {
        value: 'Enable',
        label: 'Enable',
    }];

    const wallets_afterpay_v2_use_on_checkout_options = [{ value: 'Yes', label: 'Yes' }, { value: 'No', label: 'No' }];

    const wallets_afterpay_v2_fraud_options = [{ value: 'Disable', label: 'Disable' }, {
        value: 'Enable',
        label: 'Enable',
    }];

    const wallets_afterpay_v2_direct_charge_options = [{ value: 'Disable', label: 'Disable' }, {
        value: 'Enable',
        label: 'Enable',
    }];
    ...
    const alternative_payment_methods_zippay_use_on_checkout_options = [{ value: 'Yes', label: 'Yes' }, {
        value: 'No',
        label: 'No',
    }];

    const alternative_payment_methods_zippay_fraud_options = [{ value: 'Disable', label: 'Disable' }, {
        value: 'Enable',
        label: 'Enable',
    }];
    ...
    const formik = useFormik({
        initialValues: {
            ...
            wallets_google_pay_use_on_checkout: 'No',
            ...
            wallets_paypal_smart_button_use_on_checkout: 'No',
            ...
            wallets_afterpay_v2_use_on_checkout: 'No',
            ...
            alternative_payment_methods_afterpay_v1_use_on_checkout: 'No',
            ...
            alternative_payment_methods_zippay_use_on_checkout: 'No',
        ...
        onSubmit: async (values, formik) => {
            ...
            try {
                await new ValidationPaydockData(values).validateSandbox();
    ...
    return (<>
        <div className={styles.paySettingsHead}>
            ...
            <div className={styles.paySettingsButtonWrap}>
                {error && (<ContentNotification type="error">{error.message}</ContentNotification>)}
                {success && (<ContentNotification type="success">Your settings have been saved</ContentNotification>)}
                <div>
            ...
            <CollapsiblePanel header="API Credential" isDefaultClosed={false} className="collapsible-panel">
                <Constraints.Horizontal max={'scale'}>
                    <Spacings.Stack scale="xl">
                        ...
                        {formik.values.credentials_type === 'credentials' && (<PasswordField
                        ...
                        {formik.values.credentials_type === 'access_key' && (<PasswordField
                    ...
                    <Spacings.Stack scale="xl">
                        ...
                        <AsyncSelectField
                          ...
                          loadOptions={(searchText) => {
                              ...
                              return delay(250).then(() => card_supported_card_schemes_options.filter((item) => item.label
                                .toLowerCase()
                        ...
                        {formik.values.card_3ds !== 'Disable' && (<TextField
                        ...
                        {formik.values.card_fraud !== 'Disable' && (<TextField
                        ...
                        {formik.values.card_card_save !== 'Disable' && (<SelectField
            ...
            <CollapsiblePanel header="Bank accounts" isDefaultClosed={true} className="collapsible-panel">
                <Constraints.Horizontal max={'scale'}>
                    <Spacings.Stack scale="xl">
                        ...
                        {formik.values.bank_accounts_bank_account_save !== 'No' && (<SelectField
                        ...
                        <CollapsiblePanel header="Apple pay" isDefaultClosed={true} className="collapsible-panel">
                            <Constraints.Horizontal max={'scale'}>
                                <Spacings.Stack scale="xl">
                                    ...
                                    {formik.values.wallets_apple_pay_fraud !== 'Disable' && (<TextField
                        ...
                        <CollapsiblePanel header="Google pay" isDefaultClosed={true} className="collapsible-panel">
                            <Constraints.Horizontal max={'scale'}>
                                <Spacings.Stack scale="xl">
                                    ...
                                    {formik.values.wallets_google_pay_fraud !== 'Disable' && (<TextField
                        ...
                        <CollapsiblePanel header="PayPal Smart Button" isDefaultClosed={true}
                            ...
                            <Constraints.Horizontal max={'scale'}>
                                <Spacings.Stack scale="xl">
                                    ...
                                    {formik.values.wallets_paypal_smart_button_fraud !== 'Disable' && (<TextField
                        ...
                        <CollapsiblePanel header="Afterpay v2" isDefaultClosed={true} className="collapsible-panel">
                            <Constraints.Horizontal max={'scale'}>
                                <Spacings.Stack scale="xl">
                                    ...
                                    {formik.values.wallets_afterpay_v2_fraud !== 'Disable' && (<TextField
                        ...
                        <CollapsiblePanel header="Zippay" isDefaultClosed={true} className="collapsible-panel">
                            <Constraints.Horizontal max={'scale'}>
                                <Spacings.Stack scale="xl">
                                    ...
                                    {formik.values.alternative_payment_methods_zippay_fraud !== 'Disable' && (<TextField
